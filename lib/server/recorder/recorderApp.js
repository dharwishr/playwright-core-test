...
class RecorderApp extends _events.EventEmitter {
  ...
  async setSelector(selector, userGesture) {
    if (userGesture) {
      var _this$_recorder, _this$_recorder2;
      if (((_this$_recorder = this._recorder) === null || _this$_recorder === void 0 ? void 0 : _this$_recorder.mode()) === 'getText') {
        ...
        var _this$_inspectedConte2;
        (_this$_inspectedConte2 = this._inspectedContext) === null || _this$_inspectedConte2 === void 0 || _this$_inspectedConte2.emit(_browserContext.BrowserContext.Events.OnAction, {
          frame: {
            pageAlias: 'page'
          },
          action: {
      ...
      if (((_this$_recorder2 = this._recorder) === null || _this$_recorder2 === void 0 ? void 0 : _this$_recorder2.mode()) === 'inspecting') {
        this._recorder.setMode('standby');
        this._page.bringToFront();
      } else {
        var _this$_recorder3;
        (_this$_recorder3 = this._recorder) === null || _this$_recorder3 === void 0 || _this$_recorder3.setMode('recording');
      }
    }
