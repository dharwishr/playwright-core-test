...
function calculatePlatform() {
  ...
  if (platform === 'linux') {
    ...
    if ((distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === 'debian' || (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === 'raspbian' || (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === 'devuan') {
      const isOfficiallySupportedPlatform = (distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.id) === 'debian';
      let debianVersion = distroInfo === null || distroInfo === void 0 ? void 0 : distroInfo.version;
      ...
      if (debianVersion === '11') return {
        hostPlatform: 'debian11' + archSuffix,
        isOfficiallySupportedPlatform
      };
      if (debianVersion === '12') return {
